    ...
    render() {
        return (
            ...
            <h1> Kontaktformular </h1>
             <h2> Ich freue mich von Ihnen zu hören </h2> </div>
            ...
            <Form.Group>
            <Form.Select name = "reason"
            fluid label = 'Kontaktgrund'
            options = { options }
